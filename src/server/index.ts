...
import { stageSpecTool } from './tools/author/stage-spec.js';
...
import { validateSpecTool } from './tools/author/validate-spec.js';
...
- render_flow_png(against:'staged') returns png_path — Read it; render_flow_svg for SVG. Show user; validate_flow(against:'staged'); get_staged_change gives staged_hash; preview_flow_diff before deploy_staged_change. User confirms.
...
export const ALL_TOOLS: readonly Tool<unknown, unknown>[] = [
  ...
  validateSpecTool as unknown as Tool<unknown, unknown>,
  stageSpecTool as unknown as Tool<unknown, unknown>,
