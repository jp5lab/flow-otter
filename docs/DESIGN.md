...
6. **2026-07-06 FULLY FIXED declaration recorded.** FULLY FIXED was declared at commit `740dd5d` per `scripts/eval/replay/AUDIT-RERUN.md`; the committed public summary is [`docs/audits/2026-07-06-audit-rerun.md`](audits/2026-07-06-audit-rerun.md). D4's benchmark gate passed twice with the S6 frozen thresholds untouched (`thresholds.json` sha256 `e61d7bb58d94ccebf7915a6e6f0cdaff49ec8272d25183ab20070231458d2380`; `PROTOCOL.md` sha256 `dc29a8d4047a3de2ce48fe8398b617c1d95a826a8419e70fb100207cdb0103a9`). DESIGN-D7's default-on flip is confirmed: `spec_authoring` and `layout` stay default-on in v2.0.0, with demoted toolsets callable through the deprecation window. Fix-plan Phases 1-4 are complete.
